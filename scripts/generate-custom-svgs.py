...
def create_creative_lateral_svg():
...
def main():
    ...
    svg_configs = [
        (create_cto_leadership_svg(), ASSETS_DIR / "2-engineering/1-cto-office/041-architecture-cto-leadership-guardian.svg"),
        (create_coo_leadership_svg(), ASSETS_DIR / "3-operations/1-coo-office/091-operations-coo-leadership-guardian.svg"),
        (create_first_principles_svg(), ASSETS_DIR / "4-thinktank/1-analytical/101-thinktank-first-principles-guardian.svg"),
        (create_mathematician_svg(), ASSETS_DIR / "4-thinktank/1-analytical/104-thinktank-mathematician-logical-guardian.svg"),
        (create_creative_lateral_svg(), ASSETS_DIR / "4-thinktank/2-creative/103-thinktank-creative-lateral-guardian.svg"),
        (create_inventor_svg(), ASSETS_DIR / "4-thinktank/2-creative/105-thinktank-inventor-innovative-guardian.svg"),
        (create_human_patterns_svg(), ASSETS_DIR / "4-thinktank/3-human-centered/102-thinktank-human-patterns-guardian.svg"),
        (create_psychologist_svg(), ASSETS_DIR / "4-thinktank/3-human-centered/106-thinktank-psychologist-behavioral-guardian.svg"),
        (create_child_naive_svg(), ASSETS_DIR / "4-thinktank/4-unconventional/107-thinktank-child-naive-guardian.svg"),
        (create_contrarian_svg(), ASSETS_DIR / "4-thinktank/4-unconventional/108-thinktank-contrarian-challenger-guardian.svg"),
    ]
