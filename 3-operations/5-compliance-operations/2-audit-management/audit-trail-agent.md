...
description: Comprehensive audit trail management, log analysis, and evidence collection. Centralizes audit logs, monitors compliance events, and generates audit evidence documentation. MUST BE USED for audit trail analysis, compliance logging, and forensic evidence collection tasks.
